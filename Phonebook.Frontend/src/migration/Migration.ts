import { migration1, migration2, migration3, migration5 } from 'src/migration/migrations/';

const MIGRATIONS: Migration[] = [migration1, migration2, migration3, migration5];
