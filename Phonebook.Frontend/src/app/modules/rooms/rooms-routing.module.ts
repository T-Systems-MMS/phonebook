...
const routes: Routes = [
  {
    path: '', component: RoomTreeComponent, children: [
      { path: '', component: OverviewComponent, pathMatch: 'full' },
      {
        path: ':cityId', component: CityComponent
      },
      {
        path: ':cityId/:buildingId', component: BuildingComponent
      },
      {
        path: ':cityId/:buildingId/:floorId', component: FloorComponent
      },
      {
        path: ':cityId/:buildingId/:floorId/:roomId', component: RoomDetailComponent
      }
    ]
  },
  { path: '**', redirectTo: '' }
