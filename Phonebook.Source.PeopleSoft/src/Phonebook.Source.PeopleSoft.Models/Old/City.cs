  ...
  public class City {
    ...
    public string Name {
      get {
        ...
        if (room.BuildingPart != null && room.BuildingPart.Building != null &&
            room.BuildingPart.Building.Location != null) {
          return room.BuildingPart.Building.Location.Name;
        }
        if (room.Floor != null && room.Floor.Building != null &&
            room.Floor.Building.Location != null) {
    ...
    public string Building {
      get {
        ...
        if (room.BuildingPart != null && room.BuildingPart.Building != null &&
            room.BuildingPart.Building.Name != null) {
          return room.BuildingPart.Building.Name;
        }
        if (room.Floor != null && room.Floor.Building != null &&
            room.Floor.Building.Name != null) {
    ...
    public string ZipCode {
      get {
        ...
        if (room.BuildingPart != null && room.BuildingPart.Building != null &&
            room.BuildingPart.Building.Address != null) {
          zipcodeString = room.BuildingPart.Building.Address;
        } else if (room.Floor != null && room.Floor.Building != null &&
                   room.Floor.Building.Address != null) {
