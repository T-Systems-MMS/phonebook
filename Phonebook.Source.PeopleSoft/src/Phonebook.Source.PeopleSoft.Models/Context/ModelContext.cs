...
namespace Phonebook.Source.PeopleSoft.Models.Context {
  public class ModelContext : DbContext {
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder) {
      ...
      // TODO: Yes I know all this "Tables" are views. But this is the solution
      // for the ef core provider for oracle to join over views.
      ...
      // BuildingPart
      modelBuilder.Entity<BuildingPart>()
      ...
      // OrgUnitToFunction
      modelBuilder.Entity<OrgUnitToFunction>().HasKey(
          d => new {d.PersonId, d.OrgUnitId, d.FunctionId});

      modelBuilder.Entity<OrgUnitToFunction>()
    ...
    public DbSet<BuildingPart>BuildingParts {
      get;
      set;
    }
    ...
    public DbSet<OrgUnitToFunction>OrgUnitToFunction {
      get;
      set;
    }
  }
