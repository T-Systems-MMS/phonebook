...
export const runtimeEnvironment: RuntimeEnvironmentInterface = {
  ...
  employeePicturesEndpoint:
    ENV.employeePicturesEndpoint !== '${EMPLOYEE_PICTURES_ENDPOINT}' ? ENV.employeePicturesEndpoint : undefined,
  ...
  smartSpacesUrl: ENV.smartSpacesUrl !== '${SMARTSPACES_URL}' ? ENV.smartSpacesUrl : undefined,
