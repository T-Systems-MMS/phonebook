...
# State all variables which are substituted here
variables=( BASE_URL SERVER_NAME ENVIRONMENT ENVIRONMENT_TAG RAVEN_URL EMPLOYEE_PICTURES_ENDPOINT ASSETS_ENDPOINT CONTACT_EMAIL CONTACT_URL ROOMPLANNINGTOOL_URL)
